...
Copyright (c) 2014 Primio developers
...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless Primio

See readme-qt.rst for instructions on building Primio-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in Primio
...
Notes
-----
The release is built with GCC and then `strip Primiod` to strip the debug
...
Security
--------
To help make your Primio installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Primio should be built with a non-executable stack
