...
const QString BITCOIN_IPC_PREFIX("Primio:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Primio: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Primio: click-to-pay handler");
    else
...
{
    // clicking on Primio: URLs creates FileOpen events on the Mac:
